...
<p align="center">
  <picture>
    <source media="(max-width: 760px) and (prefers-color-scheme: dark)" srcset="./assets/hero/agent-console-c21763c9-mobile-dark.svg">
    <source media="(max-width: 760px)" srcset="./assets/hero/agent-console-c21763c9-mobile-light.svg">
    <source media="(prefers-color-scheme: dark)" srcset="./assets/hero/agent-console-c21763c9-dark.svg">
    <source media="(prefers-color-scheme: light)" srcset="./assets/hero/agent-console-c21763c9-light.svg">
    <img src="./assets/hero/agent-console-c21763c9-dark.svg" alt="Baraja Putra - Frontend Developer & Web Developer" width="100%">
  </picture>
</p>
